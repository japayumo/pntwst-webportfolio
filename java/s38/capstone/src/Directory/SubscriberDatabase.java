...
public class SubscriberDatabase {
    ...
    static {
        ...
        subscriberArray.add(user4);
        subscriberArray.add(user5);
        subscriberArray.add(user6);
        subscriberArray.add(user7);
        subscriberArray.add(user8);
        subscriberArray.add(user9);
        subscriberArray.add(user10);
    }//static
